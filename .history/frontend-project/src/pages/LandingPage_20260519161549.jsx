...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-slate-900 dark:to-slate-950">
      ...
      {/* Problem & Solution Section - Professional Colors */}
<section className="py-16 bg-white dark:bg-slate-900">
  <div className="container px-4 mx-auto">
    <div className="grid gap-8 md:grid-cols-2">
      
      {/* Before CRPMS - Professional Dark/Warning Theme */}
      <div className="transition-all duration-300 border-l-4 shadow-lg card bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-l-amber-500 hover:shadow-xl">
        <div className="flex items-center gap-3 mb-4">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-amber-500">
            <span className="text-xl text-white">❌</span>
          </div>
          <h3 className="text-xl font-bold text-amber-800 dark:text-amber-400">Before CRPMS (Paper System)</h3>
        </div>
        <ul className="space-y-3">
          <li className="flex items-center gap-3 p-2 rounded-lg text-amber-700 dark:text-amber-300 bg-amber-100/50 dark:bg-amber-900/20">
          ...
          <li className="flex items-center gap-3 p-2 rounded-lg text-amber-700 dark:text-amber-300 bg-amber-100/50 dark:bg-amber-900/20">
            <span className="w-2 h-2 rounded-full bg-amber-500"></span>
            Difficult to track service history
          </li>
          <li className="flex items-center gap-3 p-2 rounded-lg text-amber-700 dark:text-amber-300 bg-amber-100/50 dark:bg-amber-900/20">
            <span className="w-2 h-2 rounded-full bg-amber-500"></span>
            Error-prone payment calculations
          </li>
          <li className="flex items-center gap-3 p-2 rounded-lg text-amber-700 dark:text-amber-300 bg-amber-100/50 dark:bg-amber-900/20">
            <span className="w-2 h-2 rounded-full bg-amber-500"></span>
            Hard to generate daily reports
          </li>
        </ul>
      </div>

      {/* After CRPMS - Professional Success Theme */}
      <div className="transition-all duration-300 border-l-4 shadow-lg card bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/30 dark:to-green-950/30 border-l-emerald-500 hover:shadow-xl">
        <div className="flex items-center gap-3 mb-4">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-emerald-500">
            <span className="text-xl text-white">✅</span>
          </div>
          <h3 className="text-xl font-bold text-emerald-800 dark:text-emerald-400">After CRPMS (Digital System)</h3>
        </div>
        <ul className="space-y-3">
          <li className="flex items-center gap-3 p-2 rounded-lg text-emerald-700 dark:text-emerald-300 bg-emerald-100/50 dark:bg-emerald-900/20">
            <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
            Quick digital recording
          </li>
          <li className="flex items-center gap-3 p-2 rounded-lg text-emerald-700 dark:text-emerald-300 bg-emerald-100/50 dark:bg-emerald-900/20">
            <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
          ...
          <li className="flex items-center gap-3 p-2 rounded-lg text-emerald-700 dark:text-emerald-300 bg-emerald-100/50 dark:bg-emerald-900/20">
            <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
            Easy car service history lookup
          </li>
          <li className="flex items-center gap-3 p-2 rounded-lg text-emerald-700 dark:text-emerald-300 bg-emerald-100/50 dark:bg-emerald-900/20">
            <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
